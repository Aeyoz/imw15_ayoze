...
# Definimos el programa y devolvemos el resultado por pantalla en función de lo que valga la variable div.
...
# Programa elaborado por: Ayoze Hernández, Ángel David y David Quintero